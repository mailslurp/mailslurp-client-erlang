...
-export([wait_for/2, wait_for/3,
         ...
         wait_for_latest_sms/2, wait_for_latest_sms/3,
...
%% @doc Wait for the latest SMS message to match the provided filter conditions such as body contains keyword.
%% Wait until a phone number meets given conditions or return immediately if already met
-spec wait_for_latest_sms(ctx:ctx(), maislurp-client-erlang_wait_for_single_sms_options:maislurp-client-erlang_wait_for_single_sms_options()) -> {ok, maislurp-client-erlang_sms_dto:maislurp-client-erlang_sms_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_latest_sms(Ctx, MaislurpClientErlangWaitForSingleSmsOptions) ->
    wait_for_latest_sms(Ctx, MaislurpClientErlangWaitForSingleSmsOptions, #{}).

-spec wait_for_latest_sms(ctx:ctx(), maislurp-client-erlang_wait_for_single_sms_options:maislurp-client-erlang_wait_for_single_sms_options(), maps:map()) -> {ok, maislurp-client-erlang_sms_dto:maislurp-client-erlang_sms_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_latest_sms(Ctx, MaislurpClientErlangWaitForSingleSmsOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangWaitForSingleSmsOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
