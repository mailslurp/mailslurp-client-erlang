...
-export([create_new_inbox_ruleset/2, create_new_inbox_ruleset/3,
         ...
         test_inbox_ruleset_receiving/2, test_inbox_ruleset_receiving/3,
         test_inbox_ruleset_sending/2, test_inbox_ruleset_sending/3,
...
%% @doc Test receiving with inbox rulesets
%% Test whether inbound emails from an email address would be blocked or allowed by inbox rulesets
-spec test_inbox_ruleset_receiving(ctx:ctx(), maislurp-client-erlang_test_inbox_ruleset_receiving_options:maislurp-client-erlang_test_inbox_ruleset_receiving_options()) -> {ok, maislurp-client-erlang_test_inbox_ruleset_receiving_result:maislurp-client-erlang_test_inbox_ruleset_receiving_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
test_inbox_ruleset_receiving(Ctx, MaislurpClientErlangTestInboxRulesetReceivingOptions) ->
    test_inbox_ruleset_receiving(Ctx, MaislurpClientErlangTestInboxRulesetReceivingOptions, #{}).

-spec test_inbox_ruleset_receiving(ctx:ctx(), maislurp-client-erlang_test_inbox_ruleset_receiving_options:maislurp-client-erlang_test_inbox_ruleset_receiving_options(), maps:map()) -> {ok, maislurp-client-erlang_test_inbox_ruleset_receiving_result:maislurp-client-erlang_test_inbox_ruleset_receiving_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
test_inbox_ruleset_receiving(Ctx, MaislurpClientErlangTestInboxRulesetReceivingOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangTestInboxRulesetReceivingOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    maislurp-client-erlang_utils:request(Ctx, Method, [?BASE_URL, Path], QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Test sending with inbox rulesets
%% Test whether outbound emails to an email address would be blocked or allowed by inbox rulesets
-spec test_inbox_ruleset_sending(ctx:ctx(), maislurp-client-erlang_test_inbox_ruleset_sending_options:maislurp-client-erlang_test_inbox_ruleset_sending_options()) -> {ok, maislurp-client-erlang_test_inbox_ruleset_sending_result:maislurp-client-erlang_test_inbox_ruleset_sending_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
test_inbox_ruleset_sending(Ctx, MaislurpClientErlangTestInboxRulesetSendingOptions) ->
    test_inbox_ruleset_sending(Ctx, MaislurpClientErlangTestInboxRulesetSendingOptions, #{}).

-spec test_inbox_ruleset_sending(ctx:ctx(), maislurp-client-erlang_test_inbox_ruleset_sending_options:maislurp-client-erlang_test_inbox_ruleset_sending_options(), maps:map()) -> {ok, maislurp-client-erlang_test_inbox_ruleset_sending_result:maislurp-client-erlang_test_inbox_ruleset_sending_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
test_inbox_ruleset_sending(Ctx, MaislurpClientErlangTestInboxRulesetSendingOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
