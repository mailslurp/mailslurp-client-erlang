...
-spec get_thread(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_thread_projection:maislurp-client-erlang_thread_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_thread(Ctx, ThreadId) ->
    get_thread(Ctx, ThreadId, #{}).

-spec get_thread(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_thread_projection:maislurp-client-erlang_thread_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
...
-spec get_threads_paginated(ctx:ctx()) -> {ok, maislurp-client-erlang_page_thread_projection:maislurp-client-erlang_page_thread_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_threads_paginated(Ctx) ->
    get_threads_paginated(Ctx, #{}).

-spec get_threads_paginated(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_thread_projection:maislurp-client-erlang_page_thread_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
