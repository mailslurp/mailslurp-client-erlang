...
create_alias(Ctx, CreateAliasOptions) ->
    create_alias(Ctx, CreateAliasOptions, #{}).
...
create_alias(Ctx, CreateAliasOptions, Optional) ->
...
-spec get_alias_threads(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_thread_projection:maislurp-client-erlang_page_thread_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_alias_threads(Ctx, AliasId) ->
    get_alias_threads(Ctx, AliasId, #{}).

-spec get_alias_threads(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_thread_projection:maislurp-client-erlang_page_thread_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
...
reply_to_alias_email(Ctx, AliasId, EmailId, ReplyToAliasEmailOptions) ->
    reply_to_alias_email(Ctx, AliasId, EmailId, ReplyToAliasEmailOptions, #{}).
...
reply_to_alias_email(Ctx, AliasId, EmailId, ReplyToAliasEmailOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = ReplyToAliasEmailOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec send_alias_email(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_sent_email_dto:maislurp-client-erlang_sent_email_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
send_alias_email(Ctx, AliasId) ->
    send_alias_email(Ctx, AliasId, #{}).

-spec send_alias_email(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_sent_email_dto:maislurp-client-erlang_sent_email_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
send_alias_email(Ctx, AliasId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% 
-spec update_alias(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_update_alias_options:maislurp-client-erlang_update_alias_options()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
update_alias(Ctx, AliasId, UpdateAliasOptions) ->
    update_alias(Ctx, AliasId, UpdateAliasOptions, #{}).

-spec update_alias(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_update_alias_options:maislurp-client-erlang_update_alias_options(), maps:map()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
update_alias(Ctx, AliasId, UpdateAliasOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
