...
-export([generate_structured_content_from_attachment/2, generate_structured_content_from_attachment/3,
...
-spec generate_structured_content_from_attachment(ctx:ctx(), maislurp-client-erlang_generate_structured_content_attachment_options:maislurp-client-erlang_generate_structured_content_attachment_options()) -> {ok, maislurp-client-erlang_structured_content_result:maislurp-client-erlang_structured_content_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
generate_structured_content_from_attachment(Ctx, MaislurpClientErlangGenerateStructuredContentAttachmentOptions) ->
    generate_structured_content_from_attachment(Ctx, MaislurpClientErlangGenerateStructuredContentAttachmentOptions, #{}).

-spec generate_structured_content_from_attachment(ctx:ctx(), maislurp-client-erlang_generate_structured_content_attachment_options:maislurp-client-erlang_generate_structured_content_attachment_options(), maps:map()) -> {ok, maislurp-client-erlang_structured_content_result:maislurp-client-erlang_structured_content_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
