...
-export([create_transformer/2, create_transformer/3,
         ...
         export_transformer_results/2, export_transformer_results/3,
         ...
         get_export_transformer_results_job/2, get_export_transformer_results_job/3,
         ...
         get_transformer_results_table/3, get_transformer_results_table/4,
         get_transformers/1, get_transformers/2,
         invoke_transformer/2, invoke_transformer/3,
         test_transformer_mapping_match/2, test_transformer_mapping_match/3,
...
%% @doc Export transformer results
%% Export AI transformer results in formats such as Excel, CSV, XML etc.
-spec export_transformer_results(ctx:ctx(), maislurp-client-erlang_export_transformer_options:maislurp-client-erlang_export_transformer_options()) -> {ok, maislurp-client-erlang_export_transformer_response:maislurp-client-erlang_export_transformer_response(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
export_transformer_results(Ctx, MaislurpClientErlangExportTransformerOptions) ->
    export_transformer_results(Ctx, MaislurpClientErlangExportTransformerOptions, #{}).

-spec export_transformer_results(ctx:ctx(), maislurp-client-erlang_export_transformer_options:maislurp-client-erlang_export_transformer_options(), maps:map()) -> {ok, maislurp-client-erlang_export_transformer_response:maislurp-client-erlang_export_transformer_response(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
export_transformer_results(Ctx, MaislurpClientErlangExportTransformerOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangExportTransformerOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get export transformer results job
%% Get the job status for an export
-spec get_export_transformer_results_job(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_export_transformer_result_job_dto:maislurp-client-erlang_export_transformer_result_job_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_export_transformer_results_job(Ctx, Id) ->
    get_export_transformer_results_job(Ctx, Id, #{}).

-spec get_export_transformer_results_job(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_export_transformer_result_job_dto:maislurp-client-erlang_export_transformer_result_job_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_export_transformer_results_job(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/ai/transformer/results/export/", Id, ""],
    QS = [],
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
...
get_transformer_results(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['emailId', 'smsId', 'attachmentId', 'aiTransformId', 'aiTransformMappingId', 'entityId', 'entityType', 'page', 'size', 'sort'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get transformer results table
%% Get AI transformer results in table format
-spec get_transformer_results_table(ctx:ctx(), boolean(), boolean()) -> {ok, maislurp-client-erlang_page_table_data:maislurp-client-erlang_page_table_data(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_transformer_results_table(Ctx, IncludeMetaData, FlattenArraysToRows) ->
    get_transformer_results_table(Ctx, IncludeMetaData, FlattenArraysToRows, #{}).

-spec get_transformer_results_table(ctx:ctx(), boolean(), boolean(), maps:map()) -> {ok, maislurp-client-erlang_page_table_data:maislurp-client-erlang_page_table_data(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_transformer_results_table(Ctx, IncludeMetaData, FlattenArraysToRows, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/ai/transformer/results/table"],
    QS = lists:flatten([{<<"includeMetaData">>, IncludeMetaData}, {<<"flattenArraysToRows">>, FlattenArraysToRows}])++maislurp-client-erlang_utils:optional_params(['emailId', 'smsId', 'attachmentId', 'aiTransformId', 'aiTransformMappingId', 'entityId', 'entityType', 'page', 'size', 'sort'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Test transformer mapping match result
%% Evaluate transform mapping match conditions for given email, sms, or attachment
-spec test_transformer_mapping_match(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_a_i_transform_mapping_match_result:maislurp-client-erlang_a_i_transform_mapping_match_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
test_transformer_mapping_match(Ctx, Id) ->
    test_transformer_mapping_match(Ctx, Id, #{}).

-spec test_transformer_mapping_match(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_a_i_transform_mapping_match_result:maislurp-client-erlang_a_i_transform_mapping_match_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
test_transformer_mapping_match(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/ai/transformer/mappings/", Id, "/match"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['emailId', 'smsId', 'attachmentId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
