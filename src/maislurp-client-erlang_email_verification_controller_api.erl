...
-export([delete_all_validation_requests/1, delete_all_validation_requests/2,
         ...
         get_email_intelligence/2, get_email_intelligence/3,
...
%% @doc Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
...
-spec get_email_intelligence(ctx:ctx(), maislurp-client-erlang_email_intelligence_options:maislurp-client-erlang_email_intelligence_options()) -> {ok, maislurp-client-erlang_email_intelligence_list_result:maislurp-client-erlang_email_intelligence_list_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_email_intelligence(Ctx, MaislurpClientErlangEmailIntelligenceOptions) ->
    get_email_intelligence(Ctx, MaislurpClientErlangEmailIntelligenceOptions, #{}).

-spec get_email_intelligence(ctx:ctx(), maislurp-client-erlang_email_intelligence_options:maislurp-client-erlang_email_intelligence_options(), maps:map()) -> {ok, maislurp-client-erlang_email_intelligence_list_result:maislurp-client-erlang_email_intelligence_list_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_email_intelligence(Ctx, MaislurpClientErlangEmailIntelligenceOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangEmailIntelligenceOptions,
