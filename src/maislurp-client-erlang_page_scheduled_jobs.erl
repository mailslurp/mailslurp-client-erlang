-module(maislurp-client-erlang_page_scheduled_jobs).

-export([encode/1]).

-export_type([maislurp-client-erlang_page_scheduled_jobs/0]).

-type maislurp-client-erlang_page_scheduled_jobs() ::
    #{ 'content' => list(),
