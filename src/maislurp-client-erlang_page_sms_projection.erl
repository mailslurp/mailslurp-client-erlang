-module(maislurp-client-erlang_page_sms_projection).

-export([encode/1]).

-export_type([maislurp-client-erlang_page_sms_projection/0]).

-type maislurp-client-erlang_page_sms_projection() ::
    #{ 'content' => list(),
