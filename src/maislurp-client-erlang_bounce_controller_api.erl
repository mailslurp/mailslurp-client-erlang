...
-export([filter_bounced_recipient/2, filter_bounced_recipient/3,
         get_account_bounce_block_status/1, get_account_bounce_block_status/2,
         ...
         get_complaint/2, get_complaint/3,
         get_complaints/1, get_complaints/2,
         get_list_unsubscribe_recipients/1, get_list_unsubscribe_recipients/2,
         get_reputation_items/1, get_reputation_items/2,
         get_tenant_reputation_findings/1, get_tenant_reputation_findings/2,
         get_tenant_reputation_status_summary/1, get_tenant_reputation_status_summary/2]).
...
%% @doc Can account send email
%% Check if account block status prevents sending
-spec get_account_bounce_block_status(ctx:ctx()) -> {ok, maislurp-client-erlang_account_bounce_block_dto:maislurp-client-erlang_account_bounce_block_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_account_bounce_block_status(Ctx) ->
    get_account_bounce_block_status(Ctx, #{}).

-spec get_account_bounce_block_status(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_account_bounce_block_dto:maislurp-client-erlang_account_bounce_block_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_account_bounce_block_status(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get complaint
%% Get complaint
-spec get_complaint(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_complaint:maislurp-client-erlang_complaint(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_complaint(Ctx, Id) ->
    get_complaint(Ctx, Id, #{}).

-spec get_complaint(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_complaint:maislurp-client-erlang_complaint(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_complaint(Ctx, Id, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/bounce/complaints/", Id, ""],
    QS = [],
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
...
%% @doc Get paginated list of reputation items.
%% List of complaints and bounces
-spec get_reputation_items(ctx:ctx()) -> {ok, maislurp-client-erlang_page_reputation_items:maislurp-client-erlang_page_reputation_items(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_reputation_items(Ctx) ->
    get_reputation_items(Ctx, #{}).

-spec get_reputation_items(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_reputation_items:maislurp-client-erlang_page_reputation_items(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_reputation_items(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get SES tenant reputation findings
%% Get SES tenant reputation recommendations/findings for this user.
-spec get_tenant_reputation_findings(ctx:ctx()) -> {ok, maislurp-client-erlang_tenant_reputation_findings_dto:maislurp-client-erlang_tenant_reputation_findings_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_tenant_reputation_findings(Ctx) ->
    get_tenant_reputation_findings(Ctx, #{}).

-spec get_tenant_reputation_findings(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_tenant_reputation_findings_dto:maislurp-client-erlang_tenant_reputation_findings_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_tenant_reputation_findings(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/bounce/tenant-findings"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['accountRegion'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get SES tenant status summary
%% Get SES tenant sending and reputation status rows for this user. Includes complaint and bounce rates from CloudWatch.
-spec get_tenant_reputation_status_summary(ctx:ctx()) -> {ok, maislurp-client-erlang_tenant_reputation_status_summary_dto:maislurp-client-erlang_tenant_reputation_status_summary_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_tenant_reputation_status_summary(Ctx) ->
    get_tenant_reputation_status_summary(Ctx, #{}).

-spec get_tenant_reputation_status_summary(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_tenant_reputation_status_summary_dto:maislurp-client-erlang_tenant_reputation_status_summary_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_tenant_reputation_status_summary(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
