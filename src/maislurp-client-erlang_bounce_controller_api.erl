...
-spec get_bounced_email(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_bounce:maislurp-client-erlang_bounce(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_bounced_email(Ctx, Id) ->
    get_bounced_email(Ctx, Id, #{}).

-spec get_bounced_email(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_bounce:maislurp-client-erlang_bounce(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
...
%% @doc Get a bounced email.
%% Bounced emails are email you have sent that were rejected by a recipient
-spec get_bounced_recipient(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_bounce_recipient:maislurp-client-erlang_bounce_recipient(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_bounced_recipient(Ctx, Id) ->
    get_bounced_recipient(Ctx, Id, #{}).

-spec get_bounced_recipient(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_bounce_recipient:maislurp-client-erlang_bounce_recipient(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
