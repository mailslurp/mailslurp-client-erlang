...
get_all_webhook_results(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter', 'since', 'before', 'unseenOnly', 'resultType', 'eventName', 'minStatusCode', 'maxStatusCode', 'inboxId', 'smsId', 'attachmentId', 'emailId', 'phoneId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_all_webhooks(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter', 'since', 'inboxId', 'phoneId', 'before', 'health', 'eventType', 'url'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
update_webhook(Ctx, WebhookId, MaislurpClientErlangCreateWebhookOptions, Optional) ->
    ...
    Method = patch,
    Path = ["/webhooks/", WebhookId, ""],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['inboxId', 'phoneNumberId', 'overrideAuth'], _OptionalParams),
    Headers = [],
    Body1 = MaislurpClientErlangCreateWebhookOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
