...
%% @doc Get test webhook payload example
%% 
-spec get_test_webhook_payload(ctx:ctx()) -> {ok, maislurp-client-erlang_webhook_payload:maislurp-client-erlang_webhook_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload(Ctx) ->
    get_test_webhook_payload(Ctx, #{}).

-spec get_test_webhook_payload(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_webhook_payload:maislurp-client-erlang_webhook_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
