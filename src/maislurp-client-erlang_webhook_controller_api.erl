...
-export([create_account_webhook/2, create_account_webhook/3,
         ...
         create_webhook_for_ai_transformer/3, create_webhook_for_ai_transformer/4,
         create_webhook_for_phone_number/3, create_webhook_for_phone_number/4,
         ...
         get_all_account_webhooks/1, get_all_account_webhooks/2,
         get_all_webhook_endpoints/1, get_all_webhook_endpoints/2,
         ...
         get_phone_number_webhooks_paginated/2, get_phone_number_webhooks_paginated/3,
         ...
         get_test_webhook_payload_delivery_status/1, get_test_webhook_payload_delivery_status/2,
         ...
         get_test_webhook_payload_new_ai_transform_result/1, get_test_webhook_payload_new_ai_transform_result/2,
...
%% @doc Attach a WebHook URL to an AI transformer
%% Get notified whenever AI transformation pipeline converts and email or SMS into structured data via a WebHook URL.
-spec create_webhook_for_ai_transformer(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_webhook_options:maislurp-client-erlang_create_webhook_options()) -> {ok, maislurp-client-erlang_webhook_dto:maislurp-client-erlang_webhook_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_webhook_for_ai_transformer(Ctx, TransformerId, MaislurpClientErlangCreateWebhookOptions) ->
    create_webhook_for_ai_transformer(Ctx, TransformerId, MaislurpClientErlangCreateWebhookOptions, #{}).

-spec create_webhook_for_ai_transformer(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_webhook_options:maislurp-client-erlang_create_webhook_options(), maps:map()) -> {ok, maislurp-client-erlang_webhook_dto:maislurp-client-erlang_webhook_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_webhook_for_ai_transformer(Ctx, TransformerId, MaislurpClientErlangCreateWebhookOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Attach a WebHook URL to a phone number
%% Get notified whenever a phone number receives an SMS via a WebHook URL.
-spec create_webhook_for_phone_number(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_webhook_options:maislurp-client-erlang_create_webhook_options()) -> {ok, maislurp-client-erlang_webhook_dto:maislurp-client-erlang_webhook_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_webhook_for_phone_number(Ctx, PhoneNumberId, MaislurpClientErlangCreateWebhookOptions) ->
    create_webhook_for_phone_number(Ctx, PhoneNumberId, MaislurpClientErlangCreateWebhookOptions, #{}).

-spec create_webhook_for_phone_number(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_webhook_options:maislurp-client-erlang_create_webhook_options(), maps:map()) -> {ok, maislurp-client-erlang_webhook_dto:maislurp-client-erlang_webhook_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_webhook_for_phone_number(Ctx, PhoneNumberId, MaislurpClientErlangCreateWebhookOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/phone/numbers/", PhoneNumberId, "/webhooks"],
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangCreateWebhookOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
...
%% @doc List account webhooks Paginated
%% List account webhooks in paginated form. Allows for page index, page size, and sort direction.
-spec get_all_account_webhooks(ctx:ctx()) -> {ok, maislurp-client-erlang_page_webhook_projection:maislurp-client-erlang_page_webhook_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_all_account_webhooks(Ctx) ->
    get_all_account_webhooks(Ctx, #{}).

-spec get_all_account_webhooks(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_webhook_projection:maislurp-client-erlang_page_webhook_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_all_account_webhooks(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/webhooks/account/paginated"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'since', 'before', 'eventType', 'health', 'searchFilter'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc List Webhooks endpoints Paginated
%% List webhooks URL in paginated form. Allows for page index, page size, and sort direction.
-spec get_all_webhook_endpoints(ctx:ctx()) -> {ok, maislurp-client-erlang_page_webhook_endpoint_projection:maislurp-client-erlang_page_webhook_endpoint_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_all_webhook_endpoints(Ctx) ->
    get_all_webhook_endpoints(Ctx, #{}).

-spec get_all_webhook_endpoints(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_webhook_endpoint_projection:maislurp-client-erlang_page_webhook_endpoint_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_all_webhook_endpoints(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/webhooks/endpoints"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter', 'since', 'inboxId', 'phoneId', 'before', 'health', 'eventType'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_all_webhook_results(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter', 'since', 'before', 'unseenOnly', 'resultType', 'eventName', 'minStatusCode', 'maxStatusCode', 'inboxId', 'smsId', 'attachmentId', 'emailId', 'phoneId', 'aiTransformerId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_all_webhooks(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter', 'since', 'inboxId', 'aiTransformerId', 'phoneId', 'before', 'health', 'eventType', 'url', 'eventTypeSource', 'includeAccountWide'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_inbox_webhooks_paginated(Ctx, InboxId, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter', 'since', 'before', 'health', 'eventType', 'includeAccountWide'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get paginated webhooks for a phone number
%% 
-spec get_phone_number_webhooks_paginated(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_webhook_projection:maislurp-client-erlang_page_webhook_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_phone_number_webhooks_paginated(Ctx, PhoneId) ->
    get_phone_number_webhooks_paginated(Ctx, PhoneId, #{}).

-spec get_phone_number_webhooks_paginated(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_webhook_projection:maislurp-client-erlang_page_webhook_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_phone_number_webhooks_paginated(Ctx, PhoneId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/phone/numbers/", PhoneId, "/webhooks/paginated"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'since', 'before', 'eventType', 'searchFilter', 'health', 'includeAccountWide'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get webhook test payload for delivery status event
%% 
-spec get_test_webhook_payload_delivery_status(ctx:ctx()) -> {ok, maislurp-client-erlang_webhook_delivery_status_payload:maislurp-client-erlang_webhook_delivery_status_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload_delivery_status(Ctx) ->
    get_test_webhook_payload_delivery_status(Ctx, #{}).

-spec get_test_webhook_payload_delivery_status(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_webhook_delivery_status_payload:maislurp-client-erlang_webhook_delivery_status_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload_delivery_status(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get webhook test payload for new ai transform result event
%% 
-spec get_test_webhook_payload_new_ai_transform_result(ctx:ctx()) -> {ok, maislurp-client-erlang_webhook_new_ai_transform_result_payload:maislurp-client-erlang_webhook_new_ai_transform_result_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload_new_ai_transform_result(Ctx) ->
    get_test_webhook_payload_new_ai_transform_result(Ctx, #{}).

-spec get_test_webhook_payload_new_ai_transform_result(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_webhook_new_ai_transform_result_payload:maislurp-client-erlang_webhook_new_ai_transform_result_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload_new_ai_transform_result(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get webhook test payload for new sms event
%% 
-spec get_test_webhook_payload_new_sms(ctx:ctx()) -> {ok, maislurp-client-erlang_webhook_new_sms_payload:maislurp-client-erlang_webhook_new_sms_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload_new_sms(Ctx) ->
    get_test_webhook_payload_new_sms(Ctx, #{}).

-spec get_test_webhook_payload_new_sms(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_webhook_new_sms_payload:maislurp-client-erlang_webhook_new_sms_payload(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_test_webhook_payload_new_sms(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get a webhook results count for a webhook
%% 
-spec get_webhook_results_count(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_count_dto:maislurp-client-erlang_count_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_webhook_results_count(Ctx, WebhookId) ->
    get_webhook_results_count(Ctx, WebhookId, #{}).

-spec get_webhook_results_count(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_count_dto:maislurp-client-erlang_count_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_webhook_results_count(Ctx, WebhookId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% 
-spec get_webhooks(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, [maislurp-client-erlang_webhook_projection:maislurp-client-erlang_webhook_projection()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_webhooks(Ctx, InboxId) ->
    get_webhooks(Ctx, InboxId, #{}).

-spec get_webhooks(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, [maislurp-client-erlang_webhook_projection:maislurp-client-erlang_webhook_projection()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
...
%% @doc Redrive all webhook results that have failed status
%% Allows you to resend webhook payloads for any recorded webhook result that failed to deliver the payload.
-spec redrive_all_webhook_results(ctx:ctx()) -> {ok, maislurp-client-erlang_webhook_redrive_all_result:maislurp-client-erlang_webhook_redrive_all_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
redrive_all_webhook_results(Ctx) ->
    redrive_all_webhook_results(Ctx, #{}).

-spec redrive_all_webhook_results(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_webhook_redrive_all_result:maislurp-client-erlang_webhook_redrive_all_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
redrive_all_webhook_results(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% 
-spec update_webhook(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_webhook_options:maislurp-client-erlang_create_webhook_options()) -> {ok, maislurp-client-erlang_webhook_dto:maislurp-client-erlang_webhook_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
update_webhook(Ctx, WebhookId, MaislurpClientErlangCreateWebhookOptions) ->
    update_webhook(Ctx, WebhookId, MaislurpClientErlangCreateWebhookOptions, #{}).

-spec update_webhook(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_webhook_options:maislurp-client-erlang_create_webhook_options(), maps:map()) -> {ok, maislurp-client-erlang_webhook_dto:maislurp-client-erlang_webhook_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
update_webhook(Ctx, WebhookId, MaislurpClientErlangCreateWebhookOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = patch,
    Path = ["/webhooks/", WebhookId, ""],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['inboxId', 'aiTransformerId', 'phoneNumberId', 'overrideAuth'], _OptionalParams),
    Headers = [],
    Body1 = MaislurpClientErlangCreateWebhookOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Wait for webhook results for a webhook
%% 
-spec wait_for_webhook_results(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), integer(), integer()) -> {ok, [maislurp-client-erlang_webhook_result_dto:maislurp-client-erlang_webhook_result_dto()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_webhook_results(Ctx, WebhookId, ExpectedCount, Timeout) ->
    wait_for_webhook_results(Ctx, WebhookId, ExpectedCount, Timeout, #{}).

-spec wait_for_webhook_results(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), integer(), integer(), maps:map()) -> {ok, [maislurp-client-erlang_webhook_result_dto:maislurp-client-erlang_webhook_result_dto()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_webhook_results(Ctx, WebhookId, ExpectedCount, Timeout, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/webhooks/", WebhookId, "/wait"],
    QS = lists:flatten([{<<"expectedCount">>, ExpectedCount}, {<<"timeout">>, Timeout}])++maislurp-client-erlang_utils:optional_params([], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
