...
-export([describe_mail_server_domain/2, describe_mail_server_domain/3,
         ...
         get_dns_lookups/2, get_dns_lookups/3,
...
%% @doc Lookup DNS records for multiple domains
%% 
-spec get_dns_lookups(ctx:ctx(), maislurp-client-erlang_dns_lookups_options:maislurp-client-erlang_dns_lookups_options()) -> {ok, maislurp-client-erlang_d_ns_lookup_results:maislurp-client-erlang_d_ns_lookup_results(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_dns_lookups(Ctx, MaislurpClientErlangDnsLookupsOptions) ->
    get_dns_lookups(Ctx, MaislurpClientErlangDnsLookupsOptions, #{}).

-spec get_dns_lookups(ctx:ctx(), maislurp-client-erlang_dns_lookups_options:maislurp-client-erlang_dns_lookups_options(), maps:map()) -> {ok, maislurp-client-erlang_d_ns_lookup_results:maislurp-client-erlang_d_ns_lookup_results(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_dns_lookups(Ctx, MaislurpClientErlangDnsLookupsOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangDnsLookupsOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
