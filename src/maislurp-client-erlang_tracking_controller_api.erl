...
create_tracking_pixel(Ctx, MaislurpClientErlangCreateTrackingPixelOptions) ->
    create_tracking_pixel(Ctx, MaislurpClientErlangCreateTrackingPixelOptions, #{}).
...
create_tracking_pixel(Ctx, MaislurpClientErlangCreateTrackingPixelOptions, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangCreateTrackingPixelOptions,
