...
-spec wait_for_nth_missed_email(ctx:ctx(), integer()) -> {ok, maislurp-client-erlang_missed_email:maislurp-client-erlang_missed_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_nth_missed_email(Ctx, Index) ->
    wait_for_nth_missed_email(Ctx, Index, #{}).

-spec wait_for_nth_missed_email(ctx:ctx(), integer(), maps:map()) -> {ok, maislurp-client-erlang_missed_email:maislurp-client-erlang_missed_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
