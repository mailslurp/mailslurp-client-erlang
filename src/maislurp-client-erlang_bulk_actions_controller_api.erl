...
%% 
-spec bulk_create_inboxes(ctx:ctx(), integer()) -> {ok, [maislurp-client-erlang_inbox_dto:maislurp-client-erlang_inbox_dto()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
bulk_create_inboxes(Ctx, Count) ->
    bulk_create_inboxes(Ctx, Count, #{}).

-spec bulk_create_inboxes(ctx:ctx(), integer(), maps:map()) -> {ok, [maislurp-client-erlang_inbox_dto:maislurp-client-erlang_inbox_dto()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
...
bulk_delete_inboxes(Ctx, MaislurpClientErlangUUidArray) ->
    bulk_delete_inboxes(Ctx, MaislurpClientErlangUUidArray, #{}).
...
bulk_delete_inboxes(Ctx, MaislurpClientErlangUUidArray, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangUUidArray,
...
bulk_send_emails(Ctx, MaislurpClientErlangBulkSendEmailOptions) ->
    bulk_send_emails(Ctx, MaislurpClientErlangBulkSendEmailOptions, #{}).
...
bulk_send_emails(Ctx, MaislurpClientErlangBulkSendEmailOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangBulkSendEmailOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
