...
-export([create_totp_device_for_base32_secret_key/2, create_totp_device_for_base32_secret_key/3,
         create_totp_device_for_custom/2, create_totp_device_for_custom/3,
...
%% @doc Create a TOTP device from an base32 secret key
...
-spec create_totp_device_for_base32_secret_key(ctx:ctx(), maislurp-client-erlang_create_totp_device_base32_secret_key_options:maislurp-client-erlang_create_totp_device_base32_secret_key_options()) -> {ok, maislurp-client-erlang_totp_device_dto:maislurp-client-erlang_totp_device_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_totp_device_for_base32_secret_key(Ctx, MaislurpClientErlangCreateTotpDeviceBase32SecretKeyOptions) ->
    create_totp_device_for_base32_secret_key(Ctx, MaislurpClientErlangCreateTotpDeviceBase32SecretKeyOptions, #{}).

-spec create_totp_device_for_base32_secret_key(ctx:ctx(), maislurp-client-erlang_create_totp_device_base32_secret_key_options:maislurp-client-erlang_create_totp_device_base32_secret_key_options(), maps:map()) -> {ok, maislurp-client-erlang_totp_device_dto:maislurp-client-erlang_totp_device_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_totp_device_for_base32_secret_key(Ctx, MaislurpClientErlangCreateTotpDeviceBase32SecretKeyOptions, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangCreateTotpDeviceBase32SecretKeyOptions,
...
-spec create_totp_device_for_custom(ctx:ctx(), maislurp-client-erlang_create_totp_device_custom_options:maislurp-client-erlang_create_totp_device_custom_options()) -> {ok, maislurp-client-erlang_totp_device_dto:maislurp-client-erlang_totp_device_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_totp_device_for_custom(Ctx, MaislurpClientErlangCreateTotpDeviceCustomOptions) ->
    create_totp_device_for_custom(Ctx, MaislurpClientErlangCreateTotpDeviceCustomOptions, #{}).

-spec create_totp_device_for_custom(ctx:ctx(), maislurp-client-erlang_create_totp_device_custom_options:maislurp-client-erlang_create_totp_device_custom_options(), maps:map()) -> {ok, maislurp-client-erlang_totp_device_dto:maislurp-client-erlang_totp_device_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_totp_device_for_custom(Ctx, MaislurpClientErlangCreateTotpDeviceCustomOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangCreateTotpDeviceCustomOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_totp_device_code(Ctx, Id, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['at', 'minSecondsUntilExpire'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
