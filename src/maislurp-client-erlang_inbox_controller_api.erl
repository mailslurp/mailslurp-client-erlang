...
create_inbox(Ctx, Optional) ->
    ...
    Method = post,
    Path = ["/inboxes"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['emailAddress', 'tags', 'name', 'description', 'useDomainPool', 'favourite', 'expiresAt', 'expiresIn', 'allowTeamAccess', 'inboxType', 'virtualInbox'], _OptionalParams),
    Headers = [],
    Body1 = [],
...
get_all_inboxes(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'favourite', 'search', 'tag', 'teamAccess', 'since', 'before', 'inboxType', 'domainId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
-spec send_with_schedule(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_send_email_options:maislurp-client-erlang_send_email_options()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
send_with_schedule(Ctx, InboxId, MaislurpClientErlangSendEmailOptions) ->
    send_with_schedule(Ctx, InboxId, MaislurpClientErlangSendEmailOptions, #{}).

-spec send_with_schedule(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_send_email_options:maislurp-client-erlang_send_email_options(), maps:map()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
