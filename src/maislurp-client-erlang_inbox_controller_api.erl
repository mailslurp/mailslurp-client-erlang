...
-export([cancel_scheduled_job/2, cancel_scheduled_job/3,
         ...
         does_inbox_have_automations/1, does_inbox_have_automations/2,
         ...
         get_all_plus_addresses/1, get_all_plus_addresses/2,
         ...
         get_inbox_plus_address/3, get_inbox_plus_address/4,
         get_inbox_plus_address_by_id/2, get_inbox_plus_address_by_id/3,
         get_inbox_plus_address_emails/3, get_inbox_plus_address_emails/4,
         get_inbox_plus_address_emails_for_plus_address_id/3, get_inbox_plus_address_emails_for_plus_address_id/4,
         get_inbox_plus_addresses/2, get_inbox_plus_addresses/3,
         get_inbox_sent_count/2, get_inbox_sent_count/3,
         get_inbox_sent_emails/2, get_inbox_sent_emails/3,
         get_inbox_tags/1, get_inbox_tags/2,
         get_inbox_tags_paginated/1, get_inbox_tags_paginated/2,
         get_inboxes/1, get_inboxes/2,
         get_inboxes_by_tag/2, get_inboxes_by_tag/3,
         get_latest_email_in_inbox/3, get_latest_email_in_inbox/4,
         get_or_create_inbox_plus_address/3, get_or_create_inbox_plus_address/4,
         get_or_create_plus_address_by_full_address/2, get_or_create_plus_address_by_full_address/3,
         get_organization_inboxes/1, get_organization_inboxes/2,
         get_outboxes/1, get_outboxes/2,
         ...
         import_email_into_inbox/3, import_email_into_inbox/4,
         import_email_into_inbox_bytes/3, import_email_into_inbox_bytes/4,
         import_email_into_inbox_multipart/3, import_email_into_inbox_multipart/4,
         is_email_address_available/2, is_email_address_available/3,
...
-spec create_inbox_ruleset(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_ruleset_options:maislurp-client-erlang_create_ruleset_options()) -> {ok, maislurp-client-erlang_ruleset_dto:maislurp-client-erlang_ruleset_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_inbox_ruleset(Ctx, InboxId, MaislurpClientErlangCreateRulesetOptions) ->
    create_inbox_ruleset(Ctx, InboxId, MaislurpClientErlangCreateRulesetOptions, #{}).

-spec create_inbox_ruleset(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_create_ruleset_options:maislurp-client-erlang_create_ruleset_options(), maps:map()) -> {ok, maislurp-client-erlang_ruleset_dto:maislurp-client-erlang_ruleset_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_inbox_ruleset(Ctx, InboxId, MaislurpClientErlangCreateRulesetOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
does_inbox_exist(Ctx, EmailAddress, Optional) ->
    ...
    Method = get,
    Path = ["/inboxes/exists"],
    QS = lists:flatten([{<<"emailAddress">>, EmailAddress}])++maislurp-client-erlang_utils:optional_params(['allowCatchAll', 'ipAddress', 'sender'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Does inbox have automations
%% Check if an inbox has automations.
-spec does_inbox_have_automations(ctx:ctx()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
does_inbox_have_automations(Ctx) ->
    does_inbox_have_automations(Ctx, #{}).

-spec does_inbox_have_automations(ctx:ctx(), maps:map()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
does_inbox_have_automations(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get all sub address plus address aliases for an inbox
...
-spec get_all_plus_addresses(ctx:ctx()) -> {ok, maislurp-client-erlang_page_plus_address_projection:maislurp-client-erlang_page_plus_address_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_all_plus_addresses(Ctx) ->
    get_all_plus_addresses(Ctx, #{}).

-spec get_all_plus_addresses(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_plus_address_projection:maislurp-client-erlang_page_plus_address_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_all_plus_addresses(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/inboxes/plus-addresses"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'inboxId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_all_scheduled_jobs(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'since', 'before', 'inboxId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
get_inbox_emails_paginated(Ctx, InboxId, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'since', 'before', 'syncConnectors'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get sub address plus address for an inbox
%% Returns a plus address object based on emails that used the inbox address with a +xyz alias.
-spec get_inbox_plus_address(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address(Ctx, PlusAddressId, InboxId) ->
    get_inbox_plus_address(Ctx, PlusAddressId, InboxId, #{}).

-spec get_inbox_plus_address(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address(Ctx, PlusAddressId, InboxId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get sub address plus address by ID
%% Returns a plus address object based on emails that used the inbox address with a +xyz alias.
-spec get_inbox_plus_address_by_id(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address_by_id(Ctx, PlusAddressId) ->
    get_inbox_plus_address_by_id(Ctx, PlusAddressId, #{}).

-spec get_inbox_plus_address_by_id(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address_by_id(Ctx, PlusAddressId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/inboxes/plus-addresses/", PlusAddressId, ""],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['inboxId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
...
%% @doc Get emails for a given inbox plus address
...
-spec get_inbox_plus_address_emails(ctx:ctx(), binary(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_email_preview:maislurp-client-erlang_page_email_preview(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address_emails(Ctx, PlusAddress, InboxId) ->
    get_inbox_plus_address_emails(Ctx, PlusAddress, InboxId, #{}).

-spec get_inbox_plus_address_emails(ctx:ctx(), binary(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_email_preview:maislurp-client-erlang_page_email_preview(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address_emails(Ctx, PlusAddress, InboxId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/inboxes/", InboxId, "/plus-addresses/emails"],
    QS = lists:flatten([{<<"plusAddress">>, PlusAddress}])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'since', 'before'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get emails for a given inbox plus address
%% Returns paginated list of all emails for a given plus alias addresses found for an inbox based on received emails that used the inbox address with a +xyz alias.
-spec get_inbox_plus_address_emails_for_plus_address_id(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_email_preview:maislurp-client-erlang_page_email_preview(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address_emails_for_plus_address_id(Ctx, PlusAddressId, InboxId) ->
    get_inbox_plus_address_emails_for_plus_address_id(Ctx, PlusAddressId, InboxId, #{}).

-spec get_inbox_plus_address_emails_for_plus_address_id(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_email_preview:maislurp-client-erlang_page_email_preview(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_address_emails_for_plus_address_id(Ctx, PlusAddressId, InboxId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get sub address plus address aliases for an inbox
...
-spec get_inbox_plus_addresses(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_plus_address_projection:maislurp-client-erlang_page_plus_address_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_addresses(Ctx, InboxId) ->
    get_inbox_plus_addresses(Ctx, InboxId, #{}).

-spec get_inbox_plus_addresses(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_plus_address_projection:maislurp-client-erlang_page_plus_address_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_plus_addresses(Ctx, InboxId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get sent email count in inbox
%% 
-spec get_inbox_sent_count(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_count_dto:maislurp-client-erlang_count_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_sent_count(Ctx, InboxId) ->
    get_inbox_sent_count(Ctx, InboxId, #{}).

-spec get_inbox_sent_count(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_count_dto:maislurp-client-erlang_count_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_sent_count(Ctx, InboxId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
get_inbox_tags(Ctx, Optional) ->
    ...
    Method = get,
    Path = ["/inboxes/tags"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get inbox tags paginated
%% Get all inbox tags paginated
-spec get_inbox_tags_paginated(ctx:ctx()) -> {ok, maislurp-client-erlang_page_inbox_tags:maislurp-client-erlang_page_inbox_tags(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_tags_paginated(Ctx) ->
    get_inbox_tags_paginated(Ctx, #{}).

-spec get_inbox_tags_paginated(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_inbox_tags:maislurp-client-erlang_page_inbox_tags(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inbox_tags_paginated(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
get_inboxes(Ctx, Optional) ->
    ...
    Method = get,
    Path = ["/inboxes"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['size', 'sort', 'since', 'excludeCatchAllInboxes', 'before', 'include'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get inboxes for a tag
%% Get all inboxes for a given inbox tag
-spec get_inboxes_by_tag(ctx:ctx(), binary()) -> {ok, maislurp-client-erlang_page_inbox_projection:maislurp-client-erlang_page_inbox_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inboxes_by_tag(Ctx, Tag) ->
    get_inboxes_by_tag(Ctx, Tag, #{}).

-spec get_inboxes_by_tag(ctx:ctx(), binary(), maps:map()) -> {ok, maislurp-client-erlang_page_inbox_projection:maislurp-client-erlang_page_inbox_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_inboxes_by_tag(Ctx, Tag, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/inboxes/tags/inboxes"],
    QS = lists:flatten([{<<"tag">>, Tag}])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'searchFilter'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get or create a plus address by full address
...
-spec get_or_create_inbox_plus_address(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), binary()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_or_create_inbox_plus_address(Ctx, InboxId, FullAddress) ->
    get_or_create_inbox_plus_address(Ctx, InboxId, FullAddress, #{}).

-spec get_or_create_inbox_plus_address(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), binary(), maps:map()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_or_create_inbox_plus_address(Ctx, InboxId, FullAddress, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/inboxes/", InboxId, "/plus-addresses/get-or-create"],
    QS = lists:flatten([{<<"fullAddress">>, FullAddress}])++maislurp-client-erlang_utils:optional_params([], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get or create a plus address by full address without inbox ID
...
-spec get_or_create_plus_address_by_full_address(ctx:ctx(), binary()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_or_create_plus_address_by_full_address(Ctx, FullAddress) ->
    get_or_create_plus_address_by_full_address(Ctx, FullAddress, #{}).

-spec get_or_create_plus_address_by_full_address(ctx:ctx(), binary(), maps:map()) -> {ok, maislurp-client-erlang_plus_address_dto:maislurp-client-erlang_plus_address_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_or_create_plus_address_by_full_address(Ctx, FullAddress, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc List all inboxes with sent emails
%% List inboxes that have sent emails
-spec get_outboxes(ctx:ctx()) -> {ok, maislurp-client-erlang_page_inbox_projection:maislurp-client-erlang_page_inbox_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_outboxes(Ctx) ->
    get_outboxes(Ctx, #{}).

-spec get_outboxes(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_inbox_projection:maislurp-client-erlang_page_inbox_projection(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_outboxes(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Import email into inbox from base64 MIME
...
-spec import_email_into_inbox(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_import_email_options:maislurp-client-erlang_import_email_options()) -> {ok, maislurp-client-erlang_email:maislurp-client-erlang_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
import_email_into_inbox(Ctx, InboxId, MaislurpClientErlangImportEmailOptions) ->
    import_email_into_inbox(Ctx, InboxId, MaislurpClientErlangImportEmailOptions, #{}).

-spec import_email_into_inbox(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_import_email_options:maislurp-client-erlang_import_email_options(), maps:map()) -> {ok, maislurp-client-erlang_email:maislurp-client-erlang_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
import_email_into_inbox(Ctx, InboxId, MaislurpClientErlangImportEmailOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/inboxes/", InboxId, "/emails/import"],
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangImportEmailOptions,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    maislurp-client-erlang_utils:request(Ctx, Method, [?BASE_URL, Path], QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Import email into inbox from raw MIME bytes
...
-spec import_email_into_inbox_bytes(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_byte_array:maislurp-client-erlang_byte_array()) -> {ok, maislurp-client-erlang_email:maislurp-client-erlang_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
import_email_into_inbox_bytes(Ctx, InboxId, Body) ->
    import_email_into_inbox_bytes(Ctx, InboxId, Body, #{}).

-spec import_email_into_inbox_bytes(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maislurp-client-erlang_byte_array:maislurp-client-erlang_byte_array(), maps:map()) -> {ok, maislurp-client-erlang_email:maislurp-client-erlang_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
import_email_into_inbox_bytes(Ctx, InboxId, Body, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/inboxes/", InboxId, "/emails/import/raw"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['externalId', 'runPipeline', 'overrideMessageId'], _OptionalParams),
    Headers = [],
    Body1 = Body,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/octet-stream">>, <<"message/rfc822">>]),
    Opts = maps:get(hackney_opts, Optional, []),

    maislurp-client-erlang_utils:request(Ctx, Method, [?BASE_URL, Path], QS, ContentTypeHeader++Headers, Body1, Opts, Cfg).

%% @doc Import email into inbox from multipart EML upload
...
-spec import_email_into_inbox_multipart(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), binary()) -> {ok, maislurp-client-erlang_email:maislurp-client-erlang_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
import_email_into_inbox_multipart(Ctx, InboxId, File) ->
    import_email_into_inbox_multipart(Ctx, InboxId, File, #{}).

-spec import_email_into_inbox_multipart(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), binary(), maps:map()) -> {ok, maislurp-client-erlang_email:maislurp-client-erlang_email(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
import_email_into_inbox_multipart(Ctx, InboxId, File, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/inboxes/", InboxId, "/emails/import/multipart"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['externalId', 'runPipeline', 'overrideMessageId'], _OptionalParams),
    Headers = [],
...
%% @doc Is email address available
%% Returns whether an email address is available
-spec is_email_address_available(ctx:ctx(), binary()) -> {ok, maislurp-client-erlang_email_available_result:maislurp-client-erlang_email_available_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
is_email_address_available(Ctx, EmailAddress) ->
    is_email_address_available(Ctx, EmailAddress, #{}).

-spec is_email_address_available(ctx:ctx(), binary(), maps:map()) -> {ok, maislurp-client-erlang_email_available_result:maislurp-client-erlang_email_available_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
is_email_address_available(Ctx, EmailAddress, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
-spec list_inbox_rulesets(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_ruleset_dto:maislurp-client-erlang_page_ruleset_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
list_inbox_rulesets(Ctx, InboxId) ->
    list_inbox_rulesets(Ctx, InboxId, #{}).

-spec list_inbox_rulesets(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_ruleset_dto:maislurp-client-erlang_page_ruleset_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
