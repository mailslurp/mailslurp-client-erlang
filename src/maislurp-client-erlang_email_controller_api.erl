...
-export([apply_imap_flag_operation/3, apply_imap_flag_operation/4,
         ...
         check_email_audit1/2, check_email_audit1/3,
         ...
         create_email_audit_for_email/2, create_email_audit_for_email/3,
...
%% @doc Run aggregate email audit for a stored email
...
-spec check_email_audit1(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_email_audit_analysis_result:maislurp-client-erlang_email_audit_analysis_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
check_email_audit1(Ctx, EmailId) ->
    check_email_audit1(Ctx, EmailId, #{}).

-spec check_email_audit1(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_email_audit_analysis_result:maislurp-client-erlang_email_audit_analysis_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
check_email_audit1(Ctx, EmailId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/emails/", EmailId, "/check-email-audit"],
    QS = [],
    Headers = [],
    Body1 = [],
...
%% @doc Persist aggregate email audit for a stored email
...
-spec create_email_audit_for_email(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_email_audit_dto:maislurp-client-erlang_email_audit_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_email_audit_for_email(Ctx, EmailId) ->
    create_email_audit_for_email(Ctx, EmailId, #{}).

-spec create_email_audit_for_email(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_email_audit_dto:maislurp-client-erlang_email_audit_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
create_email_audit_for_email(Ctx, EmailId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/emails/", EmailId, "/audit"],
    QS = [],
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
