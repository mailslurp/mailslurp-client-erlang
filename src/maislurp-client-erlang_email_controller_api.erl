...
%% @doc Get email attachment bytes. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints.
...
%% @doc Get email attachment as base64 encoded string (alternative to binary responses)
...
%% @doc Get email attachment metadata
...
%% @doc Get all email attachment metadata
