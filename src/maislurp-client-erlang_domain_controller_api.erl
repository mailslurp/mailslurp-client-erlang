...
create_domain(Ctx, DomainOptions) ->
    create_domain(Ctx, DomainOptions, #{}).
...
create_domain(Ctx, DomainOptions, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
update_domain(Ctx, Id, UpdateDomainDto) ->
    update_domain(Ctx, Id, UpdateDomainDto, #{}).
...
update_domain(Ctx, Id, UpdateDomainDto, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
