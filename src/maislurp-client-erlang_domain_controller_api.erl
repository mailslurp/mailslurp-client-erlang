...
-export([add_domain_wildcard_catch_all/2, add_domain_wildcard_catch_all/3,
         ...
         get_available_domain_regions/1, get_available_domain_regions/2,
         get_available_domains/1, get_available_domains/2,
         ...
         get_mail_slurp_domains/1, get_mail_slurp_domains/2,
...
%% @doc Get all usable domains with account region status
%% List all domains available for use with email address creation, including account-region and create/send enablement flags.
-spec get_available_domain_regions(ctx:ctx()) -> {ok, maislurp-client-erlang_domain_region_groups_dto:maislurp-client-erlang_domain_region_groups_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_available_domain_regions(Ctx) ->
    get_available_domain_regions(Ctx, #{}).

-spec get_available_domain_regions(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_domain_region_groups_dto:maislurp-client-erlang_domain_region_groups_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_available_domain_regions(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/domains/available-domain-regions"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['inboxType'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Get all usable domains
%% List all domains available for use with email address creation
-spec get_available_domains(ctx:ctx()) -> {ok, maislurp-client-erlang_domain_groups_dto:maislurp-client-erlang_domain_groups_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_available_domains(Ctx) ->
    get_available_domains(Ctx, #{}).

-spec get_available_domains(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_domain_groups_dto:maislurp-client-erlang_domain_groups_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_available_domains(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc Get MailSlurp domains
%% List all MailSlurp domains used with non-custom email addresses
-spec get_mail_slurp_domains(ctx:ctx()) -> {ok, maislurp-client-erlang_domain_groups_dto:maislurp-client-erlang_domain_groups_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_mail_slurp_domains(Ctx) ->
    get_mail_slurp_domains(Ctx, #{}).

-spec get_mail_slurp_domains(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_domain_groups_dto:maislurp-client-erlang_domain_groups_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_mail_slurp_domains(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
