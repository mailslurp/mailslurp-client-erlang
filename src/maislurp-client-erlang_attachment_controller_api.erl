...
-export([delete_all_attachments/1, delete_all_attachments/2,
         ...
         get_attachments1/1, get_attachments1/2,
...
-spec get_attachments1(ctx:ctx()) -> {ok, maislurp-client-erlang_page_attachment_entity:maislurp-client-erlang_page_attachment_entity(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_attachments1(Ctx) ->
    get_attachments1(Ctx, #{}).

-spec get_attachments1(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_attachment_entity:maislurp-client-erlang_page_attachment_entity(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_attachments1(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/attachments"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'fileNameFilter', 'since', 'before'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% 
-spec upload_attachment_bytes(ctx:ctx(), list()) -> {ok, [binary()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
upload_attachment_bytes(Ctx, MaislurpClientErlangByteArrayArray) ->
    upload_attachment_bytes(Ctx, MaislurpClientErlangByteArrayArray, #{}).

-spec upload_attachment_bytes(ctx:ctx(), list(), maps:map()) -> {ok, [binary()], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
upload_attachment_bytes(Ctx, MaislurpClientErlangByteArrayArray, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
    ...
    Headers = [],
    Body1 = MaislurpClientErlangByteArrayArray,
...
upload_multipart_form(Ctx, Optional) ->
    ...
    Headers = [],
    Body1 = MaislurpClientErlangInlineObject,
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([<<"application/json">>]),
    Opts = maps:get(hackney_opts, Optional, []),
