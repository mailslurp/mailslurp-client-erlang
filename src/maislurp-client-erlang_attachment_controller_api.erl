...
-export([download_attachment_as_base64_encoded/2, download_attachment_as_base64_encoded/3,
...
%% @doc Get email attachment as base64 encoded string (alternative to binary responses). To read the content decode the Base64 encoded contents.
