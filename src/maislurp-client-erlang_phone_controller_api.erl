...
-export([create_emergency_address/2, create_emergency_address/3,
         ...
         get_phone_number_by_name/1, get_phone_number_by_name/2,
         get_phone_number_by_phone_number/1, get_phone_number_by_phone_number/2,
...
-spec get_phone_number_by_name(ctx:ctx()) -> {ok, maislurp-client-erlang_phone_number_dto:maislurp-client-erlang_phone_number_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_phone_number_by_name(Ctx) ->
    get_phone_number_by_name(Ctx, #{}).

-spec get_phone_number_by_name(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_phone_number_dto:maislurp-client-erlang_phone_number_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_phone_number_by_name(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
-spec get_phone_number_by_phone_number(ctx:ctx()) -> {ok, maislurp-client-erlang_phone_number_dto:maislurp-client-erlang_phone_number_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_phone_number_by_phone_number(Ctx) ->
    get_phone_number_by_phone_number(Ctx, #{}).

-spec get_phone_number_by_phone_number(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_phone_number_dto:maislurp-client-erlang_phone_number_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_phone_number_by_phone_number(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
