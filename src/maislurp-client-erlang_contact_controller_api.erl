...
create_contact(Ctx, MaislurpClientErlangCreateContactOptions) ->
    create_contact(Ctx, MaislurpClientErlangCreateContactOptions, #{}).
...
create_contact(Ctx, MaislurpClientErlangCreateContactOptions, Optional) ->
    ...
    QS = [],
    Headers = [],
    Body1 = MaislurpClientErlangCreateContactOptions,
...
%% 
-spec get_contact_v_card(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_contact_v_card(Ctx, ContactId) ->
    get_contact_v_card(Ctx, ContactId, #{}).

-spec get_contact_v_card(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
