...
-spec get_sent_delivery_status(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_delivery_status:maislurp-client-erlang_delivery_status(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_status(Ctx, DeliveryId) ->
    get_sent_delivery_status(Ctx, DeliveryId, #{}).

-spec get_sent_delivery_status(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_delivery_status:maislurp-client-erlang_delivery_status(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
