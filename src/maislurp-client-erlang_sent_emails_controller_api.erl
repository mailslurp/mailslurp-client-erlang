...
-export([delete_all_sent_emails/1, delete_all_sent_emails/2,
         ...
         get_sent_delivery_status/2, get_sent_delivery_status/3,
         get_sent_delivery_statuses/1, get_sent_delivery_statuses/2,
         get_sent_delivery_statuses_by_sent_id/2, get_sent_delivery_statuses_by_sent_id/3,
         ...
         wait_for_delivery_statuses/1, wait_for_delivery_statuses/2]).
...
-spec get_raw_sent_email_contents(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_raw_sent_email_contents(Ctx, EmailId) ->
    get_raw_sent_email_contents(Ctx, EmailId, #{}).

-spec get_raw_sent_email_contents(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
...
-spec get_sent_delivery_status(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_delivery_status_dto:maislurp-client-erlang_delivery_status_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_status(Ctx, DeliveryId) ->
    get_sent_delivery_status(Ctx, DeliveryId, #{}).

-spec get_sent_delivery_status(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_delivery_status_dto:maislurp-client-erlang_delivery_status_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_status(Ctx, DeliveryId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/sent/delivery-status/", DeliveryId, ""],
    QS = [],
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
...
-spec get_sent_delivery_statuses(ctx:ctx()) -> {ok, maislurp-client-erlang_page_delivery_status:maislurp-client-erlang_page_delivery_status(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_statuses(Ctx) ->
    get_sent_delivery_statuses(Ctx, #{}).

-spec get_sent_delivery_statuses(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_page_delivery_status:maislurp-client-erlang_page_delivery_status(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_statuses(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
...
%% @doc 
%% Get all sent email delivery statuses
-spec get_sent_delivery_statuses_by_sent_id(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_page_delivery_status:maislurp-client-erlang_page_delivery_status(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_statuses_by_sent_id(Ctx, SentId) ->
    get_sent_delivery_statuses_by_sent_id(Ctx, SentId, #{}).

-spec get_sent_delivery_statuses_by_sent_id(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_page_delivery_status:maislurp-client-erlang_page_delivery_status(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sent_delivery_statuses_by_sent_id(Ctx, SentId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/sent/", SentId, "/delivery-status"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['page', 'size', 'sort', 'since', 'before'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
...
-spec wait_for_delivery_statuses(ctx:ctx()) -> {ok, maislurp-client-erlang_delivery_status_dto:maislurp-client-erlang_delivery_status_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_delivery_statuses(Ctx) ->
    wait_for_delivery_statuses(Ctx, #{}).

-spec wait_for_delivery_statuses(ctx:ctx(), maps:map()) -> {ok, maislurp-client-erlang_delivery_status_dto:maislurp-client-erlang_delivery_status_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
wait_for_delivery_statuses(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = get,
    Path = ["/sent/delivery-status/wait-for"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['sentId', 'inboxId', 'timeout', 'index', 'since', 'before'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
