...
-export([delete_sent_sms_message/2, delete_sent_sms_message/3,
         ...
         get_sms_codes/3, get_sms_codes/4,
         get_sms_count/1, get_sms_count/2,
         get_sms_message/2, get_sms_message/3,
         get_unread_sms_count/1, get_unread_sms_count/2,
         mark_all_sms_as_read/1, mark_all_sms_as_read/2,
         mark_sms_as_read/2, mark_sms_as_read/3,
...
get_all_sms_messages(Ctx, Optional) ->
    ...
    Method = get,
    Path = ["/sms"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['phoneNumber', 'page', 'size', 'sort', 'since', 'before', 'search', 'favourite', 'include'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Extract verification codes from an SMS
...
-spec get_sms_codes(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_extract_codes_result:maislurp-client-erlang_extract_codes_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sms_codes(Ctx, SmsId) ->
    get_sms_codes(Ctx, SmsId, #{}).

-spec get_sms_codes(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_extract_codes_result:maislurp-client-erlang_extract_codes_result(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
get_sms_codes(Ctx, SmsId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = post,
    Path = ["/sms/", SmsId, "/codes"],
    QS = [],
    Headers = [],
...
%% @doc Mark all SMS messages as read or unread
...
-spec mark_all_sms_as_read(ctx:ctx()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
mark_all_sms_as_read(Ctx) ->
    mark_all_sms_as_read(Ctx, #{}).

-spec mark_all_sms_as_read(ctx:ctx(), maps:map()) -> {ok, [], maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
mark_all_sms_as_read(Ctx, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),

    Method = patch,
    Path = ["/sms/read"],
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['read', 'phoneNumberId'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = maislurp-client-erlang_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
...
%% @doc Mark an SMS as read or unread
...
-spec mark_sms_as_read(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid()) -> {ok, maislurp-client-erlang_sms_dto:maislurp-client-erlang_sms_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
mark_sms_as_read(Ctx, SmsId) ->
    mark_sms_as_read(Ctx, SmsId, #{}).

-spec mark_sms_as_read(ctx:ctx(), maislurp-client-erlang_u_uid:maislurp-client-erlang_u_uid(), maps:map()) -> {ok, maislurp-client-erlang_sms_dto:maislurp-client-erlang_sms_dto(), maislurp-client-erlang_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), maislurp-client-erlang_utils:response_info()}.
mark_sms_as_read(Ctx, SmsId, Optional) ->
    _OptionalParams = maps:get(params, Optional, #{}),
    Cfg = maps:get(cfg, Optional, application:get_env(kuberl, config, #{})),
