...
create_new_email_address(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++maislurp-client-erlang_utils:optional_params(['allowTeamAccess', 'useDomainPool', 'expiresAt', 'expiresIn', 'emailAddress', 'inboxType', 'description', 'name', 'tags', 'favourite', 'virtualInbox', 'useShortAddress'], _OptionalParams),
    Headers = [],
    Body1 = [],
